...
public class PublicConsultBean {
	...
	public PublicConsultBean(String subject, String age, String sex,
	...
	public PublicConsultBean() {
		// TODO 自动生成的构造函数存根
	}
	@Override
	public String toString() {
		return "PublicConsultBean [subject=" + subject + ", age=" + age + ", sex="
