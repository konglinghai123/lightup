...
public class ConsultFrag extends Fragment implements IXListViewRefreshListener, IXListViewLoadMore{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_consult, null);
	}
	...
	private void initComponent(){
		 ...
		 titlebar.showLeftAndRight("", null,getResources().getDrawable(R.drawable.ic_edit),null,new OnClickListener() {
